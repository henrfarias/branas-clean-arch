...
import CouponRepositoryDatabase from '../repository/coupon-repository-database'
import ItemRepositoryDatabase from '../repository/item-repository-database'
import OrderRepositoryDatabase from '../repository/order-repository-database'

export default class DatabaseRepositoryFactory
  implements AbstractRepositoryFactory
{
